...
//c 10 m 1:03 aprox
package com.example.retrofit.model.Personajes.RecyclerViewPersonajes
...
class AdapterPersonajes(var enviarDatos: EnviarDatos ) : RecyclerView.Adapter<AdapterPersonajes.ThisViewHolder>() {

private var dataList = emptyList<DcEntityResultP>() // c7 m 1:00


    fun updatelistRM(mDataList: List<DcEntityResultP>){
        dataList = mDataList
    ...
    override fun onBindViewHolder(holder: AdapterPersonajes.ThisViewHolder, position: Int) {//c9 m 1:57
        val mDcPersonajesRAM : DcEntityResultP = dataList[position]
    ...
    interface EnviarDatos { //c/ m3:25 y passa al datos al primer fragmento
        fun enviardatos(mdcPersonajesRAM: DcEntityResultP)
    }
