...
private var dataList = emptyList<ResultP>() // c7 m 1:00


    fun updatelistRM(mDataList: List<ResultP>){
        dataList = mDataList
    ...
    override fun onBindViewHolder(holder: AdapterPersonajes.ThisViewHolder, position: Int) {//c9 m 1:57
        val mDcPersonajesRAM : ResultP = dataList[position]
    ...
    interface EnviarDatos { //c/ m3:25 y passa al datos al primer fragmento
        fun enviardatos(mdcPersonajesRAM: ResultP)
    }
